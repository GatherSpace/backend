...
public class DevDataSeeder {
  ...
  public CommandLineRunner seedData() {
    return args -> {
      ...
      CreateAvatarRequest avatarAsh =
          CreateAvatarRequest.builder()
              .name("ash")
              .imageUrl("https://avatar.iran.liara.run/public/boy?username=Ash")
              .build();
      CreateAvatarRequest avatarSugan =
          CreateAvatarRequest.builder()
              .name("sugan")
              .imageUrl(
                  "https://png.pngtree.com/png-clipart/20231019/original/pngtree-user-profile-avatar-png-image_13369988.png")
              .build();
      CreateAvatarRequest avatarHari =
          CreateAvatarRequest.builder()
              .name("hari")
              .imageUrl("https://www.shareicon.net/data/512x512/2016/05/24/770137_man_512x512.png")
              .build();
      ...
      CreateElementRequest table =
          CreateElementRequest.builder()
              .imageUrl(
                  "https://png.pngtree.com/png-vector/20190115/ourmid/pngtree-wooden-table-furniture-dining-table-cartoon-png-image_368150.jpg")
              .height(1)
              .width(4)
              .staticValue(true)
              .build();
      CreateElementRequest tableTwo =
          CreateElementRequest.builder()
              .imageUrl(
                  "https://png.pngtree.com/png-vector/20190115/ourmid/pngtree-wooden-table-furniture-dining-table-cartoon-png-image_368150.jpg")
              .height(1)
      ...
      CreateMapRequest map =
          CreateMapRequest.builder()
              .defaultElements(List.of(defaultElement))
              .dimensions("30x30")
              .thumbnail(
                  "https://ecdn.teacherspayteachers.com/thumbitem/Blank-Grid-Map-5891891-1599938845/original-5891891-1.jpg")
              .name("COC")
              .build();
      ...
      Space space =
          Space.builder()
              .name("COC test playground")
              .height(30)
              .width(30)
              .creatorId(userService.getUser("admin").get().getId())
              .build();
