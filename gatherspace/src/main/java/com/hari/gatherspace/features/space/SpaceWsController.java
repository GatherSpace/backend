...
public class SpaceWsController extends TextWebSocketHandler {
    ...
    @Autowired
    public SpaceWsController(JwtUtil jwtUtil, UserService userService, SpaceService spaceService, SpaceWsService spaceWsService) {
    ...
    private void handleJoin(UserWs userWs, JsonNode payload) throws IOException {
        ...
        Map<String, Object> userJoinedPayload = Map.of(
                "type", "user-joined",
                "payload", Map.of(
                        "userId", userWs.getUserId(),
                        "x", userWs.getX(),
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
        ...
        if (userWs != null) {
            ...
            Map<String, Object> userLeftPayload = Map.of(
                    "type", "user-left",
